...
void userInterface::on_language_clicked()    //—мена €зыка
{
...
void userInterface::on_input_clicked()
{
    ...
    {
        case 1: //dataFromMullZip
       if (Lan) PathOfFiles = QFileDialog::getExistingDirectory(this, tr("Specify the folder with the archives"),"/home",QFileDialog::ShowDirsOnly | QFileDialog::DontResolveSymlinks); else
           PathOfFiles = QFileDialog::getExistingDirectory(this, tr("”кажите папку с архивами"),"/home",QFileDialog::ShowDirsOnly | QFileDialog::DontResolveSymlinks);
        ...
        if (chek_dire == 2) PathOfFiles = QFileDialog::getExistingDirectory(this, tr("Specify the folder"),"/home",QFileDialog::ShowDirsOnly | QFileDialog::DontResolveSymlinks);
        if (PathOfFiles.size()!=0){
        ui->line_in->setText(PathOfFiles);
