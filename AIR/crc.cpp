...
std::string CP866toWin1251(std::string str) {
  ...
  QTextCodec *win1251 = QTextCodec::codecForName("Windows-1251");
  QByteArray ba = encoded.toLocal8Bit();
  QString st_utf = cp866->toUnicode(ba);
  QByteArray ba1251 = win1251->fromUnicode(st_utf);
  QString st1251 = QString::fromLocal8Bit(ba1251);
  return std::string(st1251.toLocal8Bit());
}
